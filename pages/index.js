...
const experiences = [
  ...
  { title: 'Undergrad Research Assistant', company: 'UNC Medical School', duration: 'July 2024 - Present' },
  { title: 'Software Engineer Intern', company: 'Tesla', duration: 'Sep 2024 - Dec 2024' },
  { title: 'Technical Product Management Intern', company: 'Lenovo', duration: 'June 2024 - July 2024' },
...
return (
  <Box sx={{ mt: 10, mb: 10 }}>
    {/* Header Section */}
    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 8, flexDirection: { xs: 'column', md: 'row' } }}>
      <Box sx={{ flex: 1, pr: { md: 4, xs: 0 }, mb: { xs: 4, md: 0 } }}>
        <Typography variant="h3" component="h1" gutterBottom sx={{ fontSize: { xs: '2rem', md: '3rem' } }}>
          Welcome to my page
        </Typography>
        <Typography variant="h5" paragraph sx={{ fontSize: { xs: '1rem', md: '1.5rem' } }}>
      ...
      <Box sx={{ flex: 1, height: { xs: 250, md: 400 }, width: '100%' }}>
    ...
    {/* About Me Section */}
    <Box sx={{ mb: 14 }}>
      <Typography variant="h4" component="h2" gutterBottom sx={{ textAlign: 'left', mb: 6, fontSize: { xs: '2rem', md: '2.5rem' } }}>
        About Me
      </Typography>
      <Grid container spacing={6}>
        ...
        <Grid item xs={12} md={6}>
          <Box sx={{ position: 'relative', height: { xs: '200px', md: '300px' }, overflow: 'hidden', borderRadius: '10px' }}>
            <Image
      ...
      <Box sx={{ mt: 6, display: 'flex', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-around', textAlign: 'center' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: { xs: 2, md: 0 } }}>
    ...
    {/* Kritan's Arcade */}
    <Box sx={{ mb: 14, mt: 14 }}>
      <Typography variant="h4" component="h2" gutterBottom sx={{ textAlign: 'left', mb: 3, fontSize: { xs: '2rem', md: '2.5rem' } }}>
        Kritan&apos;s Arcade
      </Typography>
